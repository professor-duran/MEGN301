...
\usepackage{tabularx}
\usepackage{tikz}
\usetikzlibrary{positioning, arrows.meta, calc, decorations.pathreplacing, fit, backgrounds, shapes.geometric}
...
\toprule
\textbf{Component} & \textbf{Rail} & \textbf{Continuous} & \textbf{Peak} & \textbf{Notes} \\
\midrule
