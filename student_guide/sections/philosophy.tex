...
\begin{tikzpicture}[
    ...
    slabel/.style={
        font=\footnotesize\sffamily\bfseries, color=#1,
    ...
    tracelabel/.style={
        font=\footnotesize\itshape, text=minesblue!55, fill=white,
...
\node[rotate=63, font=\normalsize\sffamily\bfseries, color=vdefine!50]
    at (-2.4, -3.0) {DEFINE \& DESIGN};
\node[rotate=-63, font=\normalsize\sffamily\bfseries, color=vverify!50]
    at (15.9, -3.0) {VERIFY \& VALIDATE};

%. Bottom label ---
\node[font=\normalsize\sffamily\bfseries, color=vbuild!40]
