...
\begin{protip}
\textbf{Trace your results back to the course learning outcomes.} The final report is your opportunity to demonstrate growth across all 10 CLOs listed in the syllabus. As you write each section, ask: which CLO does this evidence support? Here is a quick mapping to help:

\begin{center}\small
\begin{tabularx}{0.95\textwidth}{@{} c X l @{}}
\toprule
\textbf{CLO} & \textbf{Outcome} & \textbf{Key Evidence} \\
\midrule
1 & Apply the engineering design process & Design evolution narrative \\
2 & Function effectively on a team & Retrospectives, contribution table \\
3 & Plan a full design-build project & Sprint planning, schedule \\
4 & Build a functional prototype & Prototype, iteration photos \\
5 & Apply project management techniques & Task boards, timelines \\
6 & Apply systems-level thinking & Architecture, interface docs \\
7 & Design appropriate experiments & Test plan, procedures \\
8 & Use modern engineering software & CAD, firmware, EDA tools \\
9 & Collect and analyze data & Test results, statistics \\
10 & Professionally document and communicate & Final report, presentation \\
\bottomrule
\end{tabularx}
\end{center}

\noindent Making these connections, even informally, strengthens your report and helps your instructor see the full scope of your learning.
\end{protip}
