...
\input{tikz_figures/fig1_connector_taxonomy}
...
\input{tikz_figures/fig2_termination_matrix}
...
\input{tikz_figures/fig4_selection_framework}
...
\begin{tabularx}{\textwidth}{l l >{\raggedright\arraybackslash}X}
  ...
  \bottomrule
\end{tabularx}
\caption{Key connector and fluid-fitting standards.}
\end{table}
