...
\textbf{Why it is dangerous}: Fretting corrosion is the most insidious failure mode because it develops slowly, manifests as intermittent contact, and is difficult to diagnose. Resistance may fluctuate between normal and open-circuit depending on vibration state.
...
\subsubsection{JIC \ang{37} Flare (SAE J514)}
...
\begin{tabularx}{\textwidth}{l c c X}
  ...
  \midrule
  JIC \ang{37} Flare & 10000\,psi & Metal-to-metal & Reassemblable; hydraulic standard \\
...
\begin{tabularx}{\textwidth}{l c X}
  ...
  \midrule
  Buna-N (Nitrile, NBR) & $-40$ to 250\,\degF{} & General purpose; petroleum-compatible \\
  Viton (FKM) & $-20$ to 400\,\degF{} & Chemical resistance; fuel systems \\
  PTFE (Teflon) & $-100$ to 500\,\degF{} & Widest range; chemically inert; no elasticity \\
  EPDM & $-65$ to 300\,\degF{} & Steam/water service; not oil-compatible \\
  \bottomrule
\end{tabularx}
...
Select the geometry that connects the fitting to your system: straight, elbow (\ang{45} or \ang{90}), tee, cross, union, reducer, or bulkhead. 

\begin{tipbox}[Minimize Joints]
Every fitting joint is a potential leak point. Design your routing to minimize the total number of fittings in a line. Avoid stacking street elbows in series; use a single \ang{90} elbow or a pre-bent tube run instead.
\end{tipbox}
...
\begin{enumerate}[leftmargin=1.5em]
  ...
  \item \textbf{For fluid systems}: Verify thread standard with a gauge before assembly. Use manufacturer torque specifications. Pressuretest every joint before commissioning; hydrostatic test at $1.5\times$ working pressure per ASME B31.3.
...
\begin{longtable}{l l p{7.5cm}}
  ...
  SAE J514 & SAE & JIC \ang{37} flare hydraulic tube fittings; dimensions and performance requirements \\
...
\begin{enumerate}[leftmargin=1.5em]
  ...
  \item \textbf{Test every connection before commissioning}: Pull-test electrical crimps, measure contact resistance with a milliohm meter, and pressuretest all fluid joints at $1.5\times$ working pressure.
\end{enumerate}
...
\begin{enumerate}[nosep,leftmargin=1.5em]
  ...
  \item Fluid connectors require matching thread standards. NPT $\neq$ BSP. JIC \ang{37} flare and compression fittings avoid the pitfalls of tapered-thread sealing.
...
\begin{enumerate}[leftmargin=1.5em]
  ...
  \item Compare the sealing mechanisms of NPT, JIC \ang{37} flare, and compression fittings. Which requires sealant?
\end{enumerate}
...
\begin{enumerate}[resume,leftmargin=1.5em]
  ...
  \item You are specifying connectors for a cooling loop carrying a 50/50 ethylene glycol--water mix at 200\,\degF{} and 50\,psi. What seal material would you select? What body material?
...
\begin{enumerate}[leftmargin=1.5em]
  ...
  \item Seal: Viton (FKM); compatible with ethylene glycol, rated to 400\,\degF{} (above the 200\,\degF{} operating temperature). Body: stainless steel or brass (both compatible with glycol--water). Avoid carbon steel unless corrosion-protected, as glycol solutions can be mildly corrosive to unprotected ferrous metals.
