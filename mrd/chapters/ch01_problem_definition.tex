...
\input{tikz_figures/fig_problem_anatomy}
...
\begin{figure}[htbp]\centering
\input{tikz_figures/fig_stakeholder_grid}
...
\begin{figure}[htbp]\centering
\input{tikz_figures/fig_elicitation_methods}
...
\begin{figure}[htbp]\centering
\input{tikz_figures/fig_needs_pipeline}
...
Competitive Analysis & 3--5 competing solutions with gap identification & Ch.~4 (concept generation) \\
