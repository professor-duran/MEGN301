...
\includegraphics[width=\textwidth]{master_figs/fig_end_of_life.png}
\caption{End-of-life pathways\index{end of life}: from active service through retirement, disposal, and material recovery.}\label{fig:eol_pathways}\end{figure}
