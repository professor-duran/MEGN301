...
\begin{figure}[htbp]\centering
\input{tikz_figures/fig_concept_process}
...
The MCU brown-out (RPN 140) is the highest-priority item; address it with decoupling capacitors\index{decoupling capacitor}, a voltage supervisor, and separate power routing (see Chapter~12).
...
\begin{figure}[htbp]\centering
\input{tikz_figures/fig_sketch_to_proto}
...
\begin{figure}[htbp]\centering
\input{tikz_figures/fig_selection_funnel}
