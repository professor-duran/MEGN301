...
\begin{tabularx}{\textwidth}{l l X c l}
  ...
  \midrule
  ABS & Cycolac & Good impact, easy to mold/paint, 80--100\,\degC{} HDT (varies by grade and test load, ASTM D648) & 0.5--0.7\% & Enclosures, LEGO \\
...
\begin{figure}[htbp]
\centering
\input{tikz_figures/fig_dfm_rules}
