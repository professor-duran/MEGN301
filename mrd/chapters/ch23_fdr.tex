...
\midrule
VCRM completeness & Every req has final status with evidence? No unaddressed items? & Ch.~5 \\
Test rigor & Measured values reported (not just PASS/FAIL)? Repeated trials? Boundary tests? & Ch.~5 \\
Failure honesty & Failures documented with root cause? Waivers justified? No hidden defects? & Ch.~5 \\
As-built accuracy & Documents match what was actually built? BOM, drawings, wiring current? & Ch.~6 \\
O\&M readiness & Quick-start usable? Spare parts identified? Maintenance plan actionable? & Ch.~7 \\
Design evolution & Journey from PDR $\to$ CDR $\to$ FDR documented with rationale? & All \\
Lessons learned & Specific and actionable? Demonstrate growth in engineering judgment? & All \\
