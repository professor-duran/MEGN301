...
\item An M6 Class 8.8 bolt has proof load $\approx$10.3\,kN (stress area 20.1\,mm$^2$, proof stress 510\,MPa). Calculate torque for 75\% proof load preload ($K=0.20$).
\end{enumerate}
...
\item 608-2RS: 8\,mm bore, 22\,mm OD. $C = 3.45$\,kN, $P = 0.05$\,kN. $L_{10} = (3.45/0.05)^3 \times 10^6/(60 \times 3000) = 1{,}825{,}000$\,hrs.
...
\item $F = 0.75 \times 10{,}300 = 7{,}725$\,N. $T = 0.20 \times 7{,}725 \times 0.006 = 9.3$\,N$\cdot$m.
\end{enumerate}
