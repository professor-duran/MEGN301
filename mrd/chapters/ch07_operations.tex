...
\input{tikz_figures/fig_system_lifecycle}

\input{tikz_figures/fig_serviceability}

\input{tikz_figures/fig_maintenance_strategies}

\input{tikz_figures/fig_eol_planning}
