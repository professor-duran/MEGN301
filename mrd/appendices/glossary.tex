...
RTM & Requirements Traceability Matrix; links each requirement to its parent need and forward to its verification method. Tracks \emph{what} must be verified. \\
...
VCRM & Verification Cross-Reference Matrix; extends the RTM by recording test status (Planned/In~Progress/PASS/FAIL/PARTIAL) at each review milestone. Tracks \emph{whether} each requirement has been verified. \\
\end{longtable}
}
