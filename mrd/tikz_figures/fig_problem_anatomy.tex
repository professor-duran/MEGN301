...
% Sub-labels
\node[font=\tiny\sffamily, color=MinesBlue, below=0.1cm of who, align=center]   {Who experiences\\the problem?};
\node[font=\tiny\sffamily, color=AccentTeal, below=0.1cm of what, align=center]  {Measurable gap\\between states};
\node[font=\tiny\sffamily, color=WarnOrange, below=0.1cm of where, align=center] {Physical/operational\\context};
\node[font=\tiny\sffamily, color=diagPurple, below=0.1cm of why, align=center]   {Consequences of\\not solving};
\node[font=\tiny\sffamily, color=diagRed, below=0.1cm of con, align=center]      {Budget, schedule,\\regulations};
