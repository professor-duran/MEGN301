...
\midrule
Just starting your project & Need problem statement and stakeholders & Ch.~1 \\
Writing requirements & Need SHALL statements and SDRD format & Ch.~3 \\
Preparing for PDR & Need concept generation and trade study & Ch.~4, Ch.~21 \\
Need circuit basics & Ohm's Law, KVL/KCL, component selection & Ch.~13 \\
Selecting a sensor or actuator & Transduction principles, specifications & Ch.~14 \\
Selecting connectors & Wire-to-wire, fluid fittings, thread types & Ch.~10 \\
Choosing a motor or pump & Sizing, driver selection, derating & Ch.~11 \\
Designing power architecture & Protection, grounding, battery safety & Ch.~12 \\
Designing a PCB & Schematic capture, layout, fab ordering & Ch.~18 \\
Programming the ESP32 & Pin mapping, protocols, firmware structure & Ch.~19 \\
Preparing for CDR & Detailed design freeze, deliverables checklist & Ch.~22 \\
Integration is failing & Bottom-up strategy, debugging process & Ch.~6, Ch.~20 \\
System not working & Systematic debugging methodology & Ch.~20 \\
Motor won't spin & Driver wiring, power rail brown-out & Ch.~11, Ch.~12 \\
Sensor readings are noisy & Grounding, decoupling, layout & Ch.~13, Ch.~18 \\
Writing test procedures & V\&V methods, TAID, VCRM & Ch.~5, Ch.~8 \\
Preparing for FDR & O\&M, post-build V\&V, deliverables & Ch.~7, Ch.~23 \\
...
\chapter{Electronics Fundamentals, Safety \& Component Selection}

\vspace{1em}

This chapter provides the foundational circuit theory, electrical safety practices, and practical component selection knowledge that supports every technical chapter in Part~II. If you are already comfortable with Ohm's Law and Kirchhoff's Laws, use this chapter as a quick reference. If these concepts are new, work through the examples before tackling amplifier circuits, power architecture, or PCB design.
...
\chapter{Systematic Debugging and Troubleshooting}

A working system is never assembled all at once. It is built in layers, verified at each layer, and only combined into the full system after each layer passes. Debugging is not what you do when something goes wrong; it is the disciplined verification process you follow at every stage. Students who skip this process and assemble everything at once (``big-bang integration,'' which Chapter~6 warns against) consistently spend 5--10$\times$ more time debugging than students who follow the bottom-up approach.
...
\textbf{3. Binary search.} Measure at the midpoint of the signal chain. If correct, fault is downstream; if not, upstream. Halves the search with each measurement.

\textbf{4. Rubber duck debugging.} Explain the problem aloud. Articulating forces you to organize your understanding and often reveals the wrong assumption.
