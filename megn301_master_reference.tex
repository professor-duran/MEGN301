...
\textbf{Part~II: Technical Reference} provides detailed design guidance for common electromechanical subsystems. These chapters are reference material; consult them when your project involves circuit analysis, connectors, power supplies, motors, pumps, protection circuits, gear trains, injection-molded parts, or printed circuit boards. Chapter~13 (Electronics Fundamentals) provides the foundational circuit theory, electrical safety practices, and component selection references that support all other technical chapters.
...
Preparing for PDR & Need concept generation and trade study & Ch.~4, Ch.~19 \\
...
Designing a PCB & Schematic capture, layout, fab ordering & Ch.~17 \\
Programming the ESP32 & Pin mapping, protocols, firmware structure & Ch.~18 \\
Preparing for CDR & Detailed design freeze, deliverables checklist & Ch.~20 \\
Integration is failing & Bottom-up strategy, debugging process & Ch.~6 \\
Motor won't spin & Driver wiring, power rail brown-out & Ch.~11, Ch.~12 \\
Sensor readings are noisy & Grounding, decoupling, layout & Ch.~13, Ch.~17 \\
Writing test procedures & V\&V methods, TAID, VCRM & Ch.~5, Ch.~8 \\
Preparing for FDR & O\&M, post-build V\&V, deliverables & Ch.~7, Ch.~21 \\
...
4 & 7--8 & Detailed design, procurement, prototyping & Ch.~10--18 & BOM, schematics, CAD, orders \\
5 & 9--10 & Fabrication, subsystem testing, integration begins & Ch.~5, 6 & Subsystem test results, \textbf{CDR} \\
6 & 11--13 & System integration, V\&V execution, debugging & Ch.~5, 6, 8 & VCRM, test reports, system demos \\
